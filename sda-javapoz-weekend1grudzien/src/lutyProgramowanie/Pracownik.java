...
public class Pracownik {
    ...
    public boolean czyPlacaJestPowyzejPodanejWartosci(float podana_wartosc) {
        return placa > podana_wartosc;
    }
   ...
   /* Pracownik pracownik = new Pracownik();
    ...
    public void usunPracownika() {
        if (!(0 < pracownik)) {
            ...
            System.out.println("Nie ma kogo usunąć.");
        }
    }*/
    ...
    public void wypiszOkrojoneDane(int index) {
        String napis = "Index: " + index + "|" + "Pracownik{" + //"Index plus znaki dopisane z ręki na dalszym etapie
                "imie='" + imie + '\'' +
                ", nazwisko='" + nazwisko + '\'' +
                ", placa=" + placa +
                '}';
